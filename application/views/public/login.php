			...
			<div class="row utype">
				<div class = "form-group col-md-10 col-md-offset-1 ">
					<label for = "usertype">Select User Type: 	</label>
							<?=form_dropdown('usertype',array('admin' => 'Admin','student' => 'Student', 'employee' => 'Employee','worker' => 'Worker'),'Admin',array('class' => 'form-control', 'name'=>'usertype','id' => 'usertype', 'required' => 'true')); ?>
